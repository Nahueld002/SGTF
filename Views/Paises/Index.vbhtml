...
<div class="flex justify-between items-center mb-6">
    <h2 class="text-3xl font-bold text-white">Países</h2>
    <button onclick="abrirModalNuevo()" class="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-lg flex items-center gap-2 transition-colors">
        <i data-lucide="plus-circle" class="w-5 h-5"></i> Crear País
    </button>
</div>

<div class="card p-4 rounded-lg overflow-x-auto">
    <table id="tablaPaises" class="w-full text-left">
        <thead class="table-header">
            <tr>
                <th class="p-4 font-semibold">Nombre</th>
                <th class="p-4 font-semibold">Código FIFA</th>
                <th class="p-4 font-semibold">Confederación</th>
...
@section Scripts
    ...
    <script src="~/Scripts/js/pais.js"></script>
End Section
