...
<div class="flex justify-between items-center mb-6">
    <h2 class="text-3xl font-bold text-white">Confederaciones</h2>
    <button onclick="abrirModalNuevo()" class="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-lg flex items-center gap-2 transition-colors">
        <i data-lucide="plus-circle" class="w-5 h-5"></i> Crear Confederación
    </button>
</div>
...
<div id="modalConfederacion" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50 p-4">
    <div id="modalConfederacionContent" class="bg-gray-800 w-full max-w-md rounded-lg shadow-lg p-8 transform transition-all scale-95 opacity-0">
        ...
        <form id="formConfederacion">
            <input type="hidden" id="txtConfederacionID" />
            <div class="mb-6">
...
@section Scripts
    ...
    <script src="~/Scripts/js/confederacion.js"></script>
End Section
